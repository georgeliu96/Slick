...
const SplashFooter = () => {
    ...
    <div className="splash-footer">
        ...
        <a href="https://www.linkedin.com/in/george-liu-740340183/" className="linkedin-link footer-link splash-container">
        ...
        <a href="https://saphknight.github.io/" className="site-link footer-link splash-container">
