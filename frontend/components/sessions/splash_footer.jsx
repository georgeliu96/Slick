...
const SplashFooter = () => {
    ...
    <div className="splash-footer">
        ...
        <a href="https://saphknight.github.io/" className="site-link footer-link"><img src="https://github.com/saphknight/Slick/blob/master/storage/personal.png" className="personal-icon"/><b className="site-label footer-label">Personal Site</b></a>
        <div></div>        
        <div></div>        
    </div>
    )
